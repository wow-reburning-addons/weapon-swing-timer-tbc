...
L["config.hunter.specific.title"] = "Настройки полосы каста выстрелов"
...
L["config.hunter.placement_mode.label"] = " Режим размещения"
L["config.hunter.placement_mode.desc"] = "Управляет тем, где отображать полосу выстрела относительно полосы правой руки игрока."
L["config.hunter.placement_mode.independent"] = "Отдельно"
L["config.hunter.placement_mode.overlay_mainhand"] = "Поверх правой руки"
L["config.hunter.placement_mode.replace_mainhand"] = "Вместо правой руки"
L["config.hunter.bar_explanation.label"] = "Пояснение полос"

L["config.spell_shot_bar.show_cast_text.label"] = " Показать текст каста"
L["config.spell_shot_bar.show_cast_text.desc"] = "Включает текст на полосе каста."
L["config.spell_shot_bar.aimed_shot.label"] = " Полоса Прицельного выстрела"
L["config.spell_shot_bar.aimed_shot.desc"] = "Разрешает показывать на полосе каста Прицельный выстрел."
L["config.spell_shot_bar.multi_shot.label"] = " Полоса Залпа"
L["config.spell_shot_bar.multi_shot.desc"] = "Разрешает показывать на полосе каста Залп."
L["config.spell_shot_bar.latency.label"] = " Полоса задержки"
L["config.spell_shot_bar.latency.desc"] = "Показывает полосу задержки на полосе каста."
...
L["config.common.display_condition.label"] = " Условие отображения"
L["config.common.display_condition.desc"] = "Управляет показом полосы в зависимости от дистанции ближнего боя до враждебной цели."
L["config.common.display_condition.always"] = "Всегда"
L["config.common.display_condition.in_melee"] = "Только в мили"
L["config.common.display_condition.out_of_melee"] = "Только вне мили"
...
L["cast.spell_shot_bar_unlocked"] = "Полоса каста выстрелов разблокирована"
