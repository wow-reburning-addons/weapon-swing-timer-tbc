        ...
        args = {
            ...
            hunter_shot_castbar = {
                ...
                args = {
                    ...
                    show_aimedshot_cast_bar = MakeToggle(character_hunter_shot_castbar_settings, "show_aimedshot_cast_bar", "config.spell_shot_bar.aimed_shot.label", "config.spell_shot_bar.aimed_shot.desc"),
                    show_multishot_cast_bar = MakeToggle(character_hunter_shot_castbar_settings, "show_multishot_cast_bar", "config.spell_shot_bar.multi_shot.label", "config.spell_shot_bar.multi_shot.desc"),
                    show_latency_bars = MakeToggle(character_hunter_shot_castbar_settings, "show_latency_bars", "config.spell_shot_bar.latency.label", "config.spell_shot_bar.latency.desc"),
                    show_cast_text = MakeToggle(character_hunter_shot_castbar_settings, "show_cast_text", "config.spell_shot_bar.show_cast_text.label", "config.spell_shot_bar.show_cast_text.desc"),
